...
/*
// TingYu parameters
extern double const hosipalization_pr[TAG];
extern const double dead_pr[TAG];
extern const double not_medical_direct_cost[TAG];
extern double const not_medical_indirect_cost[TAG];
extern double const hospitalization_highRisk_direct_cost[TAG];
extern double const hospitalization_nonHighRisk_direct_cost[TAG];
extern double const hospitalization_highRisk_indirect_cost[TAG];
extern double const hospitalization_nonHighRisk_indirect_cost[TAG];
extern double const death_highRisk_cost[TAG];
extern double const death_nonHighRisk_cost[TAG];
extern double const antivirus_highRisk_direct_cost[TAG];
extern double const antivirus_nonHighRisk_direct_cost[TAG];
extern double const antivirus_highRisk_indirect_cost[TAG];
extern double const antivirus_nonHighRisk_indirect_cost[TAG];
extern double const vaccination_direct_cost[TAG];
extern double const vaccination_indirect_cost[TAG];
 */
