...
class EpiModelParameters {
 public:
  ...
  // get TingYu parameters
  double getReimbursement() { return nReimbursement; }
  double getCostSharingRate() { return fCostSharingRate; }
  double *getnot_medical_direct_cost() {return not_medical_direct_cost;}
  double *getnot_medical_indirect_cost() {return not_medical_indirect_cost;}
  double *gethospitalization_highRisk_direct_cost() {return hospitalization_highRisk_direct_cost;}
  double *gethospitalization_nonHighRisk_direct_cost() {return hospitalization_nonHighRisk_direct_cost;}
  double *gethospitalization_highRisk_indirect_cost() {return hospitalization_highRisk_indirect_cost;}
  double *gethospitalization_nonHighRisk_indirect_cost() {return hospitalization_nonHighRisk_indirect_cost;}
  double *getdeath_highRisk_cost() {return death_highRisk_cost;}
  double *getdeath_nonHighRisk_cost() {return death_nonHighRisk_cost;}
  double *getantivirus_highRisk_direct_cost() {return antivirus_highRisk_direct_cost;}
  double *getantivirus_nonHighRisk_direct_cost() {return antivirus_nonHighRisk_direct_cost;}
  double *getantivirus_highRisk_indirect_cost() {return antivirus_highRisk_indirect_cost;}
  double *getantivirus_nonHighRisk_indirect_cost() {return antivirus_nonHighRisk_indirect_cost;}
  double *getvaccination_direct_cost() {return vaccination_direct_cost;}
  double *getvaccination_indirect_cost() {return vaccination_indirect_cost;}
  ...
  double getEFFs() { return EFFs; } // added by TingYu
 ...
 protected:
  ...
  // TingTy parameter
  double nReimbursement;
  double fCostSharingRate;

    // load hospitalization amd death prbability add TingYu
  double hosipalization_pr[TAG]; // age-specific hospitalization probability
  double dead_pr[TAG]; // age-specific death probability

// Load all the cost add TingYu
  ...
  double EFFs; // less likely to get infected
